# CodeQL Setup for deepiri-topolsea
...
- `.github/workflows/codeql.yml`
  - Defines when scans run and how GitHub Actions executes CodeQL for Python and JavaScript/TypeScript code.
- `.github/codeql/codeql-config.yml`
  - Defines what folders to include and ignore during analysis, tailored to this repository's structure.
...
```
This workflow currently runs analysis for Python and JavaScript/TypeScript.
...
Only change the language list when this repository adds production code in another supported language.
